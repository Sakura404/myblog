...
public class TokenUtil {
     ...
     * @return
     */
    private static final String JWT_SEC = "C8CD18F3869095FDD8DE9A3C24752AFA";

    public static String createJWT(long ttlMillis, String username) {
        // 指定签名的时候使用的签名算法，也就是header那部分
        SecretKey secretKey = new SecretKeySpec(JWT_SEC.getBytes(), SignatureAlgorithm.HS256.getJcaName());
